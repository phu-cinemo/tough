...
enum RequestState {
    ...
    Executing(BoxFuture<'static, reqwest::Result<reqwest::Response>>),
    /// No ongoing request.
    None,
}
...
impl std::fmt::Debug for RequestState {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            RequestState::Executing(_) => f.write_str("Executing"),
...
impl RetryStream {
    ...
    fn poll_executing(
        ...
        let RequestState::Executing(request) = &mut self.request else {
            return None;
        };
    ...
    fn poll_new_request(
        ...
        self.request = RequestState::Executing(delayed_request);
