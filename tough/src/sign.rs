...
// /// Helper trait to have trait objects of `SecureRandom` that are `Sync`.
// pub trait SecureRandomSync: SecureRandom + Sync {}
// impl<T: SecureRandom + Sync> SecureRandomSync for T {}
